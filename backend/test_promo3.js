...
async function test() {
  ...
  // Test plan-specific applicability (JIMBO applies to all plans)
  console.log('\n5. JIMBO for quarterly plan ($16.50):');
  const jimboQuarterly = await promoService.validatePromoCode('JIMBO', 'quarterly', 1650);
  console.log(jimboQuarterly);
