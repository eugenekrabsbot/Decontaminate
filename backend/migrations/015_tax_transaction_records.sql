-- Migration: 015_tax_transaction_records
...
-- No existing tables are modified — only inserts into the new one.
-- ============================================================
DO $$
DECLARE
    row_record RECORD;
...
-- ============================================================
INSERT INTO migrations (id, name, applied_at) VALUES (15, '015_tax_transaction_records', NOW())
ON CONFLICT (id) DO NOTHING;

RAISE NOTICE 'Migration 015 complete: tax_transactions table created and backfilled.';